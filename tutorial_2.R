# =============  Azure Machine Learning - Github Tutorial ==============
# https://github.com/Azure-Readiness/hol-azure-machine-learning
# Lab 2. Introduction to R, Python & Data Synth
# https://github.com/Azure-Readiness/hol-azure-machine-learning/blob/master/002-lab-data-synth.md

# Set working directory
setwd("C:\\Users\\gbens\\OneDrive\\Microsoft Azure\\Machine Learning\\GitHub")
...
# https://github.com/Azure-Readiness/hol-azure-machine-learning/blob/master/003-lab-data-interact.md
# Lab 3. AzureML Experiments & Data Interaction
